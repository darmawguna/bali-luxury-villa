...
const TestimonialCard = ({ quote, author, location, rating, imageUrl, stay }) => {
    ...
    const textContainerVariants = {
        ...
        visible: {
            opacity: 1,
            transition: { staggerChildren: 0.03, delayChildren: 0.3, duration: 0.8 }
        }
    };
    ...
    return (
        <section ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden">
            <motion.div className="absolute inset-0 z-0" style={{ y, scale }}>
                <img src={imageUrl} alt={`Background for testimonial by ${ author }`} className="w-full h-full object-cover" />
            ...
            >
                ...
                <motion.blockquote
                    className="text-3xl md:text-4xl lg:text-5xl font-serif font-extralight leading-tight mb-12"
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl font-serif font-medium tracking-wider">
                        — {author}
                    </p>
                    <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-stone-300">
                        <span className="text-sm font-sans tracking-[0.2em] uppercase">
                            {location}
                        </span>
        ...
        <div className="bg-gradient-to-br from-stone-50 via-white to-amber-50">
            ...
            >
                ...
                <div className="relative z-10">
                    <motion.span
                        className="inline-block text-amber-600 text-sm font-sans font-medium tracking-[0.2em] uppercase mb-6"
                    ...
                    <motion.h2
                        className="text-4xl md:text-6xl lg:text-7xl font-serif font-extralight text-stone-800 mb-8 leading-[1.1]"
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    />
                    <motion.p
                        className="text-lg text-stone-600 max-w-2xl mx-auto mt-8 leading-relaxed font-sans font-light"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
            ...
            >
                <motion.h3
                    className="text-2xl md:text-3xl font-serif font-light text-stone-700 mb-8"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                ...
                <motion.button
                    className="group inline-flex items-center space-x-2 bg-gradient-to-r from-amber-600 to-stone-600 text-white px-8 py-4 rounded-full font-sans font-medium shadow-lg hover:shadow-xl transition-all duration-300"
