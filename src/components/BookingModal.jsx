...
const BookingModal = ({ isBookingOpen, setIsBookingOpen }) => {
    ...
    // Reusable style for inputs, adapted for a light theme
            ...
            {isBookingOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="relative bg-gradient-to-br from-stone-50 via-white to-amber-50 w-full max-w-5xl max-h-[90vh] rounded-2xl overflow-hidden shadow-2xl"
                    >
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 h-full">
                            ...
                            <div className="p-8 md:p-12 overflow-y-auto">
                                <button onClick={() => setIsBookingOpen(false)} className="absolute top-6 right-6 text-stone-500 hover:text-stone-800 transition-colors">
                                    <FiX size={24} />
                                </button>
