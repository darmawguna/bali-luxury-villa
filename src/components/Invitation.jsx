        ...
        >
            ...
            >
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <motion.div className="inline-flex items-center gap-2 text-amber-600 text-sm font-medium tracking-[0.2em] uppercase mb-4">
                        <FiMapPin className="w-4 h-4" />
                        <span>Location</span>
                    </motion.div>

                    <motion.h2
                        className="text-5xl md:text-6xl lg:text-7xl font-extralight text-transparent bg-gradient-to-r from-stone-700 via-stone-600 to-amber-700 bg-clip-text mb-8 leading-[1.1]"
                    ...
                    >
                        YOUR INVITATION
                        <span className="block text-4xl md:text-5xl font-light text-stone-500 mt-4">
                            to Paradise
                        </span>
                    </motion.h2>
                ...
                >
                    ...
                    <div className="relative h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl border border-white/50">
                        ...
                        <motion.a
                            ...
                            className="absolute bottom-6 right-6 bg-gradient-to-r from-amber-600 to-stone-600 text-white font-medium text-sm px-6 py-3 rounded-full flex items-center gap-2 shadow-lg hover:shadow-xl transition-all duration-300 z-20 group/link"
                            whileHover={{ scale: 1.05, y: -2 }}
                            whileTap={{ scale: 0.95 }}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                        {[
                            ...
                            >
                                ...
                                <p className="text-stone-600 text-sm font-light">{item.detail}</p>
                            </motion.div>
                        ))}
                    </div>
                </motion.div>
                ...
                >
                    <motion.button
                        className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-amber-600 to-stone-600 text-white font-semibold text-lg px-10 py-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-400 overflow-hidden"
                    ...
                    <motion.p
                        className="text-stone-500 text-sm font-light mt-4 tracking-wide"
                        initial={{ opacity: 0 }}
